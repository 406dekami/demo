...
from app.db.models.mind_map import MindMapNode
...
class GraphVectorService:
    ...
    def _generate_node_text(self, node: MindMapNode) -> str:
        """
    ...
    def index_all_nodes(self, kb_id: str = "knowledge_graph", batch_size: int = 10) -> Dict[str, Any]:
        ...
        try:
            # 获取所有节点
            nodes = MindMapNode.select().order_by(MindMapNode.level, MindMapNode.title)
            total = nodes.count()
