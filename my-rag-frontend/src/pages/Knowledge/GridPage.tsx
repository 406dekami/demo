...
export const KnowledgeGridPage: FC<Props> = ({ bases, onAddBase, onDeleteBase }) => {
  ...
  return (
    <div className={`min-h-screen font-roboto ${isDark ? 'bg-linear-to-br from-gray-900 via-black to-gray-900 text-white' : 'bg-linear-to-br from-blue-50 via-white to-sky-50 text-slate-900'}`}>
      {/* Header */}
