...
export const AccountManagement: FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="font-gs text-2xl font-semibold dark:text-white text-gray-900 mb-2">账号管理</h2>
        <p className="dark:text-gray-400 text-gray-600 text-sm">管理您的账号信息和安全设置</p>
      </div>
